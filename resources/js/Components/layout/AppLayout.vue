      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="flex min-w-0 items-center">
            <span class="shrink-0 text-xl font-bold">Hệ thống Can thiệp</span>
            <div class="ml-8 hidden items-baseline space-x-2 md:flex">
...
const navClass = path => [
  ...
  'inline-flex items-center gap-1.5 rounded-md px-2.5 py-2 text-sm font-medium transition duration-150 ease-in-out',
];
